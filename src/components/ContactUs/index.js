        ...
        return (
            <div className='flex flex-col h-100 bg-whySection'>
                <div className='p-10 xl:w-4/5' >
                    ...
                    {/* Office address house no. */}
                    <h1 className='text-2xl font-bold text-gray-800'>Address</h1>
                    <p className='pt-4 text-gray-800'>Bournemouth</p>
                    <p className='pb-3 text-gray-900 font-bold'>Star Security Services Bournemouth</p>

                    <p>80 Holdenhurst Road</p>
                    <p>Lansdowne, Bournemouth</p>
                    <p>BH8 8AQ</p>
                    <p className='pb-3 text-red-500 font-bold'><span className='text-gray-900'>T:</span> +44 030458673</p>
                </div>
